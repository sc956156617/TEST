...
@interface SCPartsViewController ()<CentreViewDelegate,SCVerticalIndexViewDelegate>
{
...
@implementation SCPartsViewController
...
-(void)setUI{
    ...
    //选择品牌按钮
    self.showBandsBTemp =  Button.img(@"menu").str(@"选择精品").highColor(@"brown").color(@"white").bgColor(@"23,11,100").gap(10).xywh(kScreenW-100,0,100, 30).fitSize.addTo(self.view); // horizontal span  .
}
