...
@interface BottomPoppingLabel : UIControl
...
@property (nonatomic, strong) LableModel *model;

- (void)updateLayoutBySize:(CGSize)size finished:(void (^)(BottomPoppingLabel *item))finished; // 属性赋值后需更新布局
