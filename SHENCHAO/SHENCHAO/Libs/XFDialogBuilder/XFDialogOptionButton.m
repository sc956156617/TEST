...
- (UIView *)createMiddleLine
{
    ...
    lineView.backgroundColor = XFDialogRealValue(XFDialogLineColor, SCLineGrayColor);
...
- (void)addContentView
{
    ...
    [cancelButton setTitleColor:XFDialogRealValue(XFDialogOptionCancelTextColor, SCThemeColor) forState:UIControlStateNormal];
